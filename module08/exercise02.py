...
accounts : list[Account] = [
    Account(iban="TR1", balance=10_000_000.0, status=AccountStatus.ACTIVE),
    CheckingAccount(iban="TR2", balance=20_000_000.0, status=AccountStatus.ACTIVE, overdraft_amount=1_000_000),
    SavingsAccount(iban="TR3", balance=30_000_000.0, status=AccountStatus.ACTIVE)
]
